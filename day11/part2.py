...
class Monkey:
    ...
    def decrease_worry_level_helper(self, item_index):
        self.items[item_index] = int(self.items[item_index] % lcm)
...
class Game:
    ...
    def play(self):
        for round_index in range(0, 10000):
    ...
    def move_monkeys_items(self):
        for monkey in self.animals.monkeys:
            ...
            for item_index in range(0, len(monkey.items)):
                ...
                monkey.decrease_worry_level_helper(item_index)
